...
MODEL_DIR = os.path.join(os.path.dirname(__file__), 'C:/Users/rubic/Documents/GitHub/Digit_prediction_mnist/model')
if not os.path.isdir(MODEL_DIR):
    os.system('runipy train.ipynb')

model = load_model('C:/Users/rubic/Documents/GitHub/Digit_prediction_mnist/model')
